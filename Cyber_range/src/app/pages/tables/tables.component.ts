...
export class TablesComponent implements OnInit {
  ...
  variable:any;
  ngOnInit():void {
    this.variable=this.http.get("#").subscribe(
      data=>this.variable=data
    );
  }
  // http://192.168.252.128:8000/machinesinfo
...
//     debugger;
//
//     this.httpClient.get('http://192.168.252.128:5000/Mutil').subscribe(response => {
//
...
// ***************************************** API FOR DVWA ************************//
  run_machines(machine_name) {
    ...
    if (machine_name === 'DVWA') {
      ...
      this.httpClient.get('http://192.168.252.128:5000/DVWA').subscribe(response => { 
        // tslint:disable-next-line:prefer-constm
        let data = response as JSON;
        console.log(response);
        this.avail = '';
        this.avail = response;
      ...
      this.httpClient.get('http://192.168.252.128:5000/BWAPP').subscribe(response => {
      ...
      this.httpClient.get('http://192.168.252.128:5000/JUICE_SHOP').subscribe(responce => {
        // tslint:disable-next-line:prefer-const
      ...
      this.httpClient.get('http://192.168.252.128:5000/badstore').subscribe(responce => {
      ...
      this.httpClient.get('http://192.168.252.128:5000/XVWA').subscribe(responce => {
      ...
      this.httpClient.get('http://192.168.252.128:5000/WACKOPICKO').subscribe(responce => {
      ...
      } else if (machine_name === 'OWASPBRICKS') {
      this.httpClient.get('http://192.168.252.128:5000/OWASPBRICKS').subscribe(responce => {
      ...
      this.httpClient.get('http://192.168.252.128:5000/gruyere').subscribe(response => {
      ...
      this.httpClient.get('http://192.168.252.128:5000/hackazone').subscribe(response => {
  ...
  stopMachine(machine_name) {
    ...
    if (machine_name === 'DVWA') {
      ...
      if (this.avail !== '' || this.avail !== null || this.avail !== undefined) {
        ...
        var cc = 123;
        var isValid = this.httpClient.post('http://192.168.252.128:5000/stopMachine', abcd).subscribe(data => {
          var aa = data;
         // this.avail = '';
        });
        this.avail = ''; }
        ...
        if (this.bwwapp !== '' || this.bwwapp !== null || this.bwwapp !== undefined) {
          ...
          var cd = 123;
          var isValid = this.httpClient.post('http://192.168.252.128:5000/stopMachine', abd).subscribe(data => {
            var ab = data;
            this.bwwapp = '';
          });
          this.bwwapp = '';
          ...
          if (this.Juice_shop !== '' || this.Juice_shop !== null || this.Juice_shop !== undefined) {
            ...
            var cde = 123;
            var isValid = this.httpClient.post('http://192.168.252.128:5000/stopMachine', abde).subscribe(data => {
              var ac = data;
            });
            this.Juice_shop = '';
          }
            ...
            if (this.badstoree !== '' || this.badstoree !== null || this.badstoree !== undefined) {
              ...
              var cdf = 123;
              var isValid = this.httpClient.post('http://192.168.252.128:5000/stopMachine', abdf).subscribe(data => {
                var ad = data;
              });
              this.badstoree = '';
            }
              ...
              if (this.gruyere !== '' || this.gruyere !== null || this.gruyere !== undefined) {
                ...
                var cdg = 123;
                var isValid = this.httpClient.post('http://192.168.252.128:5000/stopMachine', abdg).subscribe(data => {
                  var a = data;
                });
                this.gruyere = '';
              }
      ...
      if (this.hackney !== '' || this.hackney !== null || this.hackney !== undefined) {
        ...
        var cc = 123;
        var isValid = this.httpClient.post('http://192.168.252.128:5000/stopMachine', aab).subscribe(data => {
          var dat = data;
        });
        this.hackney = '';
      }
      ...
      if (this.mut !== '' || this.mut !== null || this.mut !== undefined) {
        ...
        var cc = 123;
        var isValid = this.httpClient.post('http://192.168.252.128:5000/stopMachine', ab).subscribe(data => {
          var dat = data;
        });
        this.mut = '';
      }
...
// this.httpClient.post('http//:192.168.252.128:5000/stop', {port: 'avail'}).subscribe(data => {
